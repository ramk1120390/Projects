...
//TODO with name
	...
	public JSONObject deleteCountry(@RequestParam(name = "countryName") String country) {
		...
		try {
			...
			// After TODO with device find by buidling
...
//TODO delete  the api for all
//TODO update do with passing the id change the name or passing the name without change name
